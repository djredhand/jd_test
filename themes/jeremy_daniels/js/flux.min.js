		...
		flux.slider.prototype = {
			...
			setupImages: function() {
				var img1 = this.getImage(this.currentImageIndex),
					...
					var imgWidth = ($('#main-wrapper').width() ) - ($('#sidebar-first').width() );
					
					$(img1).addClass('img1_flux');
					$(img1).width(imgWidth);
	...
	(function($) {
		flux.transitions.swipe = function(fluxslider, opts) {
			return new flux.transition(fluxslider, $.extend({
				setup: function() {
				var imgWidth = ($('#main-wrapper').width() ) - ($('#sidebar-first').width() );
				//console.log(this.slider.image1.css('background-image'))
				var imgHeight = $('#sidebar-first').height();
					var img = $('<div></div>');
					var bgCss = imgWidth + 'px ';
